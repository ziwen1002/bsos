...
function hyprfocus::trait::post_install() {
    ...
    file::copy_file_dir --force "${SCRIPT_DIR_fdb555da}/320-hyprfocus.conf" "${XDG_CONFIG_HOME}/hypr/conf.d/320-hyprfocus.conf" || return "${SHELL_FALSE}"
...
function hyprfocus::trait::post_uninstall() {
    ...
    file::safe_delete_file_dir "${XDG_CONFIG_HOME}/hypr/conf.d/320-hyprfocus.conf" || return "${SHELL_FALSE}"
