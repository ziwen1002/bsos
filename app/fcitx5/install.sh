...
SCRIPT_DIR_b78e0bc7="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")")"
...
function fcitx5::_env() {
    ...
    # export PM_APP_NAME
    local name
    name="$(basename "${SCRIPT_DIR_b78e0bc7}")"
...
function fcitx5::package_name() {
    fcitx5::trait::package_name
}

function fcitx5::description() {
    fcitx5::trait::description
}

function fcitx5::dependencies() {
    fcitx5::trait::dependencies
}

function fcitx5::features() {
    fcitx5::trait::features
}

function fcitx5::install_guide() {
    fcitx5::trait::install_guide
}

function fcitx5::finally() {
    fcitx5::trait::finally
}

function fcitx5::main() {

    fcitx5::_env || return 1

    # shellcheck source=/dev/null
    source "${SCRIPT_DIR_b78e0bc7}/trait.sh" || return "$SHELL_FALSE"
