...
SCRIPT_DIR_266bcf0d="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")")"
...
function pamac::_env() {
    ...
    # export PM_APP_NAME
    local name
    name="$(basename "${SCRIPT_DIR_266bcf0d}")"
...
function pamac::package_name() {
    pamac::trait::package_name
}

function pamac::description() {
    pamac::trait::description
}

function pamac::dependencies() {
    pamac::trait::dependencies
}

function pamac::features() {
    pamac::trait::features
}

function pamac::install_guide() {
    pamac::trait::install_guide
}

function pamac::finally() {
    pamac::trait::finally
}
...
function pamac::main() {
    ...
    # shellcheck source=/dev/null
    source "${SCRIPT_DIR_266bcf0d}/trait.sh" || return "$SHELL_FALSE"
