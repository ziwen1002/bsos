...
SCRIPT_DIR_31d0c53b="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")")"
...
function vscode::_env() {
    ...
    # export PM_APP_NAME
    local name
    name="$(basename "${SCRIPT_DIR_31d0c53b}")"
...
function vscode::package_name() {
    vscode::trait::package_name
}

function vscode::description() {
    vscode::trait::description
}

function vscode::dependencies() {
    vscode::trait::dependencies
}

function vscode::features() {
    vscode::trait::features
}

function vscode::install_guide() {
    vscode::trait::install_guide
}

function vscode::finally() {
    vscode::trait::finally
}

function vscode::main() {

    vscode::_env || return 1

    # shellcheck source=/dev/null
    source "${SCRIPT_DIR_31d0c53b}/trait.sh" || return "$SHELL_FALSE"
