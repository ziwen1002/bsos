...
SCRIPT_DIR_02ee1263="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")")"
...
function hyprland::_env() {
    ...
    # export PM_APP_NAME
    local name
    name="$(basename "${SCRIPT_DIR_02ee1263}")"
...
function hyprland::_clean_build() {
...
function hyprland::package_name() {
    hyprland::trait::package_name
}

function hyprland::description() {
    hyprland::trait::description
}

function hyprland::dependencies() {
    hyprland::trait::dependencies
}

function hyprland::features() {
    hyprland::trait::features
}

function hyprland::install_guide() {
    hyprland::trait::install_guide
}

function hyprland::finally() {
    hyprland::trait::finally
}

function hyprland::main() {

    hyprland::_env || return 1

    # shellcheck source=/dev/null
    source "${SCRIPT_DIR_02ee1263}/trait.sh" || return "$SHELL_FALSE"
