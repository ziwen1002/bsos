...
function vmware_workstation::trait::_env() {
...
# 全部安装完成后的操作
function vmware_workstation::trait::finally() {
...
function vmware_workstation::trait::dependencies() {
    ...
    local apps=("default:linux-headers")
    array::print apps
    return "${SHELL_TRUE}"
}
...
function vmware_workstation::trait::main() {
    vmware_workstation::trait::_env || return "$SHELL_FALSE"
}
