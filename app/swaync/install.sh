...
SCRIPT_DIR_9fc2b29c="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")")"
...
function swaync::_env() {
    ...
    # export PM_APP_NAME
    local name
    name="$(basename "${SCRIPT_DIR_9fc2b29c}")"
...
function swaync::package_name() {
    swaync::trait::package_name
}

function swaync::description() {
    swaync::trait::description
}

function swaync::dependencies() {
    swaync::trait::dependencies
}

function swaync::features() {
    swaync::trait::features
}

function swaync::install_guide() {
    swaync::trait::install_guide
}

function swaync::finally() {
    swaync::trait::finally
}

function swaync::main() {

    swaync::_env || return 1

    # shellcheck source=/dev/null
    source "${SCRIPT_DIR_9fc2b29c}/trait.sh" || return "$SHELL_FALSE"
