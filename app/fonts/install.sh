...
SCRIPT_DIR_e1d998a6="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")")"
...
function fonts::_env() {
    ...
    # export PM_APP_NAME
    local name
    name="$(basename "${SCRIPT_DIR_e1d998a6}")"
...
function fonts::package_name() {
    fonts::trait::package_name
}

function fonts::description() {
    fonts::trait::description
}

function fonts::dependencies() {
    fonts::trait::dependencies
}

function fonts::features() {
    fonts::trait::features
}

function fonts::install_guide() {
    fonts::trait::install_guide
}

function fonts::finally() {
    fonts::trait::finally
}
...
function fonts::main() {
    ...
    # shellcheck source=/dev/null
    source "${SCRIPT_DIR_e1d998a6}/trait.sh" || return "$SHELL_FALSE"
