...
function google_chrome::_clean_build() {
...
function google_chrome::install() {
    google_chrome::_install
    if [ $? -ne "${SHELL_TRUE}" ]; then
        lerror "install app(${PM_APP_NAME}) failed"
        linfo "clean app(${PM_APP_NAME})..."
        google_chrome::uninstall
...
function google_chrome::uninstall() {
    google_chrome::_uninstall
    if [ $? -ne "${SHELL_TRUE}" ]; then
...
function google_chrome::package_name() {
    google_chrome::trait::package_name
}

function google_chrome::description() {
    google_chrome::trait::description
}

function google_chrome::dependencies() {
    google_chrome::trait::dependencies
}

function google_chrome::features() {
    google_chrome::trait::features
}

function google_chrome::install_guide() {
    google_chrome::trait::install_guide
}

function google_chrome::finally() {
    google_chrome::trait::finally
}

function google_chrome::main() {
    ...
    "package_name")
        google_chrome::package_name
        return $?
        ;;

    "description")
        google_chrome::description
        return $?
        ;;

    "dependencies")
        google_chrome::dependencies
        return $?
        ;;

    "features")
        google_chrome::features
        return $?
        ;;

    "install_guide")
        google_chrome::install_guide
        return $?
        ;;

    "finally")
        google_chrome::finally
        return $?
        ;;
    *)
