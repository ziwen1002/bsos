...
SCRIPT_DIR_83cdfcc4="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")")"
...
function zsh::_env() {
    ...
    # export PM_APP_NAME
    local name
    name="$(basename "${SCRIPT_DIR_83cdfcc4}")"
...
function zsh::package_name() {
    zsh::trait::package_name
}

function zsh::description() {
    zsh::trait::description
}

function zsh::dependencies() {
    zsh::trait::dependencies
}

function zsh::features() {
    zsh::trait::features
}

function zsh::install_guide() {
    zsh::trait::install_guide
}

function zsh::finally() {
    zsh::trait::finally
}
...
function zsh::main() {
    ...
    # shellcheck source=/dev/null
    source "${SCRIPT_DIR_83cdfcc4}/trait.sh" || return "$SHELL_FALSE"
