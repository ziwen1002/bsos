...
SCRIPT_DIR_3789cdd8="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")")"
...
function anytype::_env() {
    ...
    # export PM_APP_NAME
    local name
    name="$(basename "${SCRIPT_DIR_3789cdd8}")"
...
function anytype::package_name() {
    anytype::trait::package_name
}

function anytype::description() {
    anytype::trait::description
}

function anytype::dependencies() {
    anytype::trait::dependencies
}

function anytype::features() {
    anytype::trait::features
}

function anytype::install_guide() {
    anytype::trait::install_guide
}

function anytype::finally() {
    anytype::trait::finally
}

function anytype::main() {

    anytype::_env || return 1

    # shellcheck source=/dev/null
    source "${SCRIPT_DIR_3789cdd8}/trait.sh" || return "$SHELL_FALSE"
