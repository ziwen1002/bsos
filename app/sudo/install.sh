...
SCRIPT_DIR_c9e8554a="$(readlink -f "$(dirname "${BASH_SOURCE[0]}")")"
...
function sudo::_env() {
    ...
    # export PM_APP_NAME
    local name
    name="$(basename "${SCRIPT_DIR_c9e8554a}")"
...
function sudo::package_name() {
    sudo::trait::package_name
}

function sudo::description() {
    sudo::trait::description
}

function sudo::dependencies() {
    sudo::trait::dependencies
}

function sudo::features() {
    sudo::trait::features
}

function sudo::install_guide() {
    sudo::trait::install_guide
}

function sudo::finally() {
    sudo::trait::finally
}
...
function sudo::main() {
    ...
    # shellcheck source=/dev/null
    source "${SCRIPT_DIR_c9e8554a}/trait.sh" || return "$SHELL_FALSE"
