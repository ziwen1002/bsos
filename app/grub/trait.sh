...
# 全部安装完成后的操作
function grub::trait::finally() {
    println_info "${PM_APP_NAME}: TODO: config theme"
...
function grub::trait::main() {
    grub::trait::_env || return "$SHELL_FALSE"
}
